        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='jiaoshi'">
                    <el-form-item class="select" v-if="type!='info'"  label="指导教师" prop="jiaoshiId">
                        <el-select v-model="ruleForm.jiaoshiId" :disabled="ro.jiaoshiId" filterable placeholder="请选择指导教师" @change="jiaoshiChange">
                            <el-option
